			...
			try{
				...
				if(optionsList){
					jQuery.each(optionsList, function() {
						...
						html += '<div style="width: 30%; float: left; "><input type="text" name="i_options_key[]" value="'+newkey+'" placeholder="Option Value" style="width: 100%;background-color: #f1f2f6; border-color:lightgray; "></div>';
						html += '<div style="width: 30%; float: left; "><input type="text" name="i_options_text[]" value="'+newtxt+'" placeholder="Option Text" style="width: 100%;background-color: #f1f2f6; border-color:lightgray; "></div>';
						
						
						html +='<div class="action-cell" style="float: left;"><a href="javascript:void(0)" onclick="jwcfeAddNewOptionRow(this)" class="btn btn-blue" title="Add new option">+</a></div>';
						html += '<div class="action-cell" style="float: left;"><a href="javascript:void(0)" onclick="jwcfeRemoveOptionRow(this)" class="btn btn-red"  title="Remove option">x</a></div>';
	...
	*------------------------------------*/
	...
	_fieldTypeChangeListner = function fieldTypeChangeListner(elm){
		...
		if(type === 'select' || type === 'radio' || type === 'checkboxgroup'){
			...
			form.find('.rowFieldLabelheading').hide();
			...
			form.find('.rowMaxlength').hide();
			form.find('.rowPlaceholder').hide();
			form.find('.rowFieldLabelheading').show();
			$('#requiredchk').prop('checked', false);						
		}
	...
	// Text Add in the name field =================================
// document.addEventListener('DOMContentLoaded', function () {
// 	var input = document.getElementById('nameInput');
// 	// Set the default text inside the input field
// 	input.value = 'Billing_';
// });


// document.addEventListener('DOMContentLoaded', function() {
// 	const selectElement = document.getElementById('f_heading_type_select');
// 	const hiddenInput = document.getElementById('f_heading_type');
// 	const headingContainer = document.querySelector('.heading-container');
// 	const headingTag = headingContainer.querySelector('.heading-tag');

// 	selectElement.addEventListener('change', function() {
// 		const selectedTag = this.value;
// 		hiddenInput.value = selectedTag;
// 		const headingText = headingTag.textContent;
// 		headingContainer.innerHTML = `<${selectedTag} class="heading-tag">${headingText}</${selectedTag}>`;
// 	});
